...
export const bioSteps: BioStepData[] = [
    ...
    },
    {
        ...
        description:
            "After almost 2 years at Smart Data, I accepted a role at Core BTS to become a Sr. Software Engineer, where I am now. In August 2022, I received the company's Award of Excellence while also presenting a 4-hour workshop on machine learning at the 2022 Kansas City Developers Conference.",
        image: CoreBTSPhoto,
    },
];
